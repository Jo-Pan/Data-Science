...
class EdgeMinibatchIterator(object):
    ...
    def __init__(self, G, id2idx, 
            ...
            n2v_retrain=False, fixed_n2v=False, data_post=None,
            **kwargs):
...
class NodeMinibatchIterator(object):
    ...
    def batch_feed_dict(self, batch_nodes, val=False):
        ...
        batch_name = 'batch'
        if self.data_post is not None:
            batch_name += self.data_post

        feed_dict.update({self.placeholders[batch_name]: batch1})
